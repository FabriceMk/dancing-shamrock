...
When you start learning Irish Set Dancing, you will notice that one of the troubles is to remember all the figures and their order for each set dance.
...
* Built with Angular 5.x and Angular Material
